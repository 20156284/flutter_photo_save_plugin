package com.willcheung.flutterphotosaveplugin
...
class FlutterPhotoSavePlugin: MethodCallHandler {
  companion object {
    @JvmStatic
    fun registerWith(registrar: Registrar) {
      val channel = MethodChannel(registrar.messenger(), "flutter_photo_save_plugin")
      channel.setMethodCallHandler(FlutterPhotoSavePlugin())
    }
  }
